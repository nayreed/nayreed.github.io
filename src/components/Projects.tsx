  ...
  const projects = [
    {
      ...
      details: 'End-to-end scripts to train MLP, CNN, and SNN models with several Federated Algorithms leveraging Flower Framework, evaluate IID vs. non-IID setups.',
