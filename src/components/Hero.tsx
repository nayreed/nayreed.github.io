      ...
      <div className="container mx-auto px-6 pt-24 pb-16 relative z-10">
        <div className="flex flex-col space-y-6 max-w-4xl">
          ...
          <div>
            ...
            <AnimatedText text="Nayreed" tag="h1" className="text-5xl md:text-7xl font-bold tracking-tight bg-gradient-to-r from-primary to-blue-400 bg-clip-text text-transparent mt-2" delay={1} animation="blur-in" />
          </div>
          ...
          <div className={`flex flex-wrap gap-4 mt-6 transition-all duration-1000 delay-[1800ms] ${isVisible ? 'opacity-100' : 'opacity-0 translate-y-8'}`}>
            <a href="#contact" className="relative group bg-primary hover:bg-primary/90 text-white font-medium rounded-md px-6 py-3 transition-all duration-300 overflow-hidden">
            ...
            <a href="#experience" className="bg-white/5 hover:bg-white/10 backdrop-blur-sm border border-white/10 text-white font-medium rounded-md px-6 py-3 transition-all duration-300 flex items-center">
